...
echo 'LoadModule wsgi_module "/app/venv311/lib/python3.11/site-packages/mod_wsgi/server/mod_wsgi-py311.cpython-311-x86_64-linux-gnu.so"' >> /etc/httpd/conf/httpd.conf
echo 'WSGIPythonHome "/app/venv311"' >> /etc/httpd/conf/httpd.conf
